...
/*   Updated: 2023/02/23 16:30:35 by lkavalia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << RED << "ClapTrap" << BLANK << " Param constructor has been called!" << std::endl;
}
...
ClapTrap::ClapTrap(const ClapTrap& other)
{
	...
	std::cout << "Copy constructor has been called!" << std::endl << std::endl;
}
